...
namespace Fontis\Auspost\Api\Postage\Domestic\Parcel\Types;
...
use Fontis\Auspost\Model\Postage\PostageType;
...
class ServiceType
{
    ...
    public function listTypes(): PostageTypeCollection
    {
        ...
        if (!isset($responseBody["types"])
            || !isset($responseBody["types"]["type"])
            || !count($responseBody["types"]["type"])) {
