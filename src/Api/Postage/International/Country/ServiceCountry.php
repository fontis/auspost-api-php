...
namespace Fontis\Auspost\Api\Postage\International\Country;
...
use Fontis\Auspost\Model\Postage\Country;
...
class ServiceCountry
{
    ...
    public function listCountries(): CountryCollection
    {
        ...
        if (!isset($responseBody["countries"])
            || !isset($responseBody["countries"]["country"])
            || !count($responseBody["countries"]["country"])) {
